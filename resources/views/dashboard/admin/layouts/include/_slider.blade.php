  ...
  border-radius: 10px;
    ...
    <ul class="app-menu">
        ...
        @if (auth()->user()->hasPermission('orders_read'))
            <li><a class="app-menu__item {{ request()->segment(3) == 'orders' ? 'active' : '' }}" href="{{ route('dashboard.admin.orders.index') }}"><i class="app-menu__icon fas fa-tools"></i> <span class="app-menu__label">@lang('orders.orders')</span></a></li>
        @endif
...
{{--         @if (auth()->user()->hasPermission('product_categorys_read'))
            <li><a class="app-menu__item {{ request()->segment(3) == 'product_categorys' ? 'active' : '' }}" href="{{ route('dashboard.admin.product_categorys.index') }}"><i class="app-menu__icon fas fa-tools"></i> <span class="app-menu__label">@lang('product_categorys.product_categorys')</span></a></li>
        @endif

        @if (auth()->user()->hasPermission('categories_read'))
            <li><a class="app-menu__item {{ request()->segment(3) == 'car_categorys' ? 'active' : '' }}" href="{{ route('dashboard.admin.categoreys.index') }}"><i class="app-menu__icon fas fa-tools"></i> <span class="app-menu__label">@lang('car_categorys.car_categorys')</span></a></li>
        @endif --}}
