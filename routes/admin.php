...
Route::prefix('dashboard/admin')->name('dashboard.admin.')->middleware('auth:admin')->group(function () {
        ...
        Route::get('orders/invoice/{order}/store', [OrderController::class, 'invoiceStore'])->name('orders.invoice.store');
        Route::delete('/orders/bulk_delete', [OrderController::class, 'bulkDelete'])->name('orders.bulk_delete');
